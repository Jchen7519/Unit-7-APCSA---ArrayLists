...
public class ArrayListAlgorithms {
    ...
    public static void replaceWithCaps(ArrayList<String> wordList)
    {
        ...
        {
            String temp = i.substring(i.length() - 1);
            if (temp.equals("s"))
            {
                wordList.set(count, i.toUpperCase());
            }
            count++;
        }
    }
    ...
    public static void wackyVowels(ArrayList<String> wordList)
    {
        ...
        {
            if (wordList.get(i).indexOf("a") != -1 || wordList.get(i).indexOf("e") != -1 || wordList.get(i).indexOf("e") != -1 || wordList.get(i).indexOf("o") != -1){
                wordList.remove(i);
            }else{
